...
public class MessageRouter
{
    ...
    public MessageRouter(GameManager gameManager)
    {
        ...
        _gameManager.RoomTracker.OnBufferCleared += () => _partialLine = string.Empty;
    }
    ...
    public void ProcessMessage(string text)
    {
        ...
        // --- Door response processing for auto-walker ---
        _gameManager.AutoWalkManager.ProcessServerText(text);
    ...
    /// <summary>
    /// Clear the partial line buffer. Called before sending movement commands
    /// after door/search sequences to prevent stale prompt fragments from
    /// contaminating the next room's display.
    /// </summary>
